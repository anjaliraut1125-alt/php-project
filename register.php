                        ...
                        <form action="controlers/regi.php" method="post">
                            <div class="ps-form--contact border border-dark p-4 rounded">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-12">
                                        <div class="ps-form__group">
                                            <!-- <input class="form-control ps-form__input" type="text" placeholder="Country"  name="country"> -->
                                ...
                                <div class="ps-form__submit d-flex justify-content-center">
                                    <button class="ps-btn ps-btn--warning">Create Account</button>
                                </div>
    ...
    <div class="ps-menu--slidebar">
        <div class="ps-menu__content">
            <ul class="menu--mobile">
                ...
                <li class="menu-item-has-children"><a href="#">Home Medical Supplies</a><span class="sub-toggle"><i
                            class="fa fa-chevron-down"></i></span>
                    <ul class="sub-menu">
                                ...
                                <div class="col-12 col-xl-6">
                                    <div class="ps-product--gallery">
                                        ...
                                        <div class="ps-gallery--image">
                                            <div class="slide">
                                                <div class="ps-gallery__item"><img src="img/products/001.jpg" alt="alt">
                                                </div>
                                            </div>
                                            <div class="slide">
                                                <div class="ps-gallery__item"><img src="img/products/047.jpg" alt="alt">
                                                </div>
                                            </div>
                                            <div class="slide">
                                                <div class="ps-gallery__item"><img src="img/products/047.jpg" alt="alt">
                                            ...
                                            <div class="slide">
                                                <div class="ps-gallery__item"><img src="img/products/008.jpg" alt="alt">
                                                </div>
                                            </div>
                                            <div class="slide">
                                                <div class="ps-gallery__item"><img src="img/products/034.jpg" alt="alt">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal-body">
                    <div class="wrap-modal-slider container-fluid ps-addcart__body">
                        ...
                        <div class="ps-addcart__product">
                            <div class="ps-product ps-product--standard">
                                <div class="ps-product__thumbnail"><a class="ps-product__image" href="#">
                                        <figure><img src="img/products/015.jpg" alt=""><img src="img/products/040.jpg"
                                                alt=""></figure>
                                    </a></div>
                                <div class="ps-product__content">
