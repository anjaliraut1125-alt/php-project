                    ...
                    <div class="ps-banner" style="background:#F0F2F5;">
                        <div class="container container-initial">
                            <div class="ps-banner__block">
                                ...
                                <div class="ps-banner__thumnail"><img class="ps-banner__round" src="img/round5.png" alt="alt"><img class="ps-banner__image" src="img/promotion/slide3.png" alt="alt">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container container-initial">
                            <div class="ps-banner__block">
                                <div class="ps-banner__content">
                                    ...
                                    <div class="ps-banner__price"> <span class="text-yellow">$29.99</span>
                                        <del>$15.99</del>
                                    </div><a class="bg-yellow ps-banner__shop" href="#">Add to cart</a>
                                    <div class="ps-banner__persen bg-yellow">-30%</div>
                                </div>
                                <div class="ps-banner__thumnail ps-banner__fluid"><img class="ps-banner__image" src="img/promotion/bg-slide3-home3.jpg" alt="alt">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="ps-section--category-horizontal">
                    <div class="container">
                        ...
                        <div class="ps-category__content">
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/plastercross.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Bandages</a></div>
                            </div>
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/capsule.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Capsules</a></div>
                            </div>
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/dental.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Dental</a></div>
                            </div>
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/thermometer.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Thermometer</a></div>
                            </div>
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/heart-healt.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Heart Health</a></div>
                            </div>
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/microscope.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Micrscope</a></div>
                            </div>
                            <div class="ps-category__item"><a class="ps-category__link" href="category-grid.html"><img src="img/branch/tube.svg" alt=""></a>
                                <div class="ps-category__name"><a href="category-grid.html">Tubes</a></div>
                            </div>
                        </div>
                        <div class="ps-category__all"><a href="category-grid.html">Show all</a></div>
                    </div>
                </section>
                <div class="container">
                    ...
                    <div class="ps-promo">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="ps-promo__item"><img class="ps-promo__banner" src="img/promotion/bg-banner5.jpg" alt="alt">
                                    <div class="ps-promo__content">
                                        <h4 class="ps-promo__name">Candid <br>Whitening Kit</h4>
                                        <div class="ps-promo__sale">-10%</div><a class="ps-promo__btn" href="category-grid.html">Shop now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-promo__item"><img class="ps-promo__banner" src="img/promotion/bg-banner4.jpg" alt="alt">
                                    <div class="ps-promo__content"><span class="ps-promo__badge">New</span>
                                        <h4 class="mb-20 ps-promo__name">Get rid of bacteria <br>in your home</h4><a class="ps-promo__btn" href="category-grid.html">More</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="ps-promo__item"><img class="ps-promo__banner" src="img/promotion/bg-banner3.jpg" alt="alt">
                                    <div class="ps-promo__content">
                            ...
                            <div class="row m-0">
                                ...
                                <div class="col-6 col-md-4 col-lg-2dot4 p-0">
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            <div class="ps-product__thumbnail"><a class="ps-product__image" href="product1.html">
                                                    <figure><img src="img/products/007.jpg" alt="alt"><img src="img/products/004.jpg" alt="alt">
                                                    </figure>
                                                </a>
                                                <div class="ps-product__actions">
                                                    <div class="ps-product__item" data-toggle="tooltip" data-placement="left" title="Wishlist"><a href="#"><i class="fa fa-heart-o"></i></a></div>
                                ...
                                <div class="col-6 col-md-4 col-lg-2dot4 p-0">
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            <div class="ps-product__thumbnail"><a class="ps-product__image" href="product1.html">
                                                    <figure><img src="img/products/018.jpg" alt="alt"><img src="img/products/037.jpg" alt="alt">
                                                    </figure>
                                                </a>
                                                <div class="ps-product__actions">
                                                    <div class="ps-product__item" data-toggle="tooltip" data-placement="left" title="Wishlist"><a href="#"><i class="fa fa-heart-o"></i></a></div>
                                ...
                                <div class="col-6 col-md-4 col-lg-2dot4 p-0">
                                    <div class="ps-section__product">
                                        <div class="ps-product ps-product--standard">
                                            <div class="ps-product__thumbnail"><a class="ps-product__image" href="product1.html">
                                                    <figure><img src="img/products/019.jpg" alt="alt"><img src="img/products/037.jpg" alt="alt">
                                                    </figure>
                                                </a>
                                                <div class="ps-product__actions">
                                                    <div class="ps-product__item" data-toggle="tooltip" data-placement="left" title="Wishlist"><a href="#"><i class="fa fa-heart-o"></i></a></div>
